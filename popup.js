  ...
  return [
      ...
      tools: [
        {
          ...
          url: "https://intra.pro.laplateforme.io/",
        },
      ],
    },
    {
      ...
      tools: [
        {
          name: "Armado",
          description: "Espace intérim",
          icon: "fa-solid fa-ribbon",
          url: "https://myarmado.fr",
        },
      ],
    },
    {
      ...
      tools: [
        {
          name: "Localhost",
          description: "Votre environnement local",
    ...
    },
    {
      ...
      tools: [
        ...
        {
          name: "Site GitHub",
          description: "Votre site GitHub",
          icon: "fa-brands fa-github",
          url: `https://${username}.github.io`,
        },
        {
          name: "Panel Plesk",
          description: "Administration serveur",
          icon: "fa-solid fa-server",
          url: "https://students-laplateforme.io:8443",
        },
        {
          name: "Site Plesk",
          description: "Votre hébergement web",
          icon: "fa-solid fa-globe",
          url: `https://${username}.students-laplateforme.io`,
        },
      ],
    },
    {
        ...
        <a href="https://students-laplateforme.io:8443" target="_blank"
          ...
          <div class="tool-content">
            ...
            <div class="tool-description">${
              isConnected ? "Déjà connecté ✅" : "Connexion requise ⚠️"
            }</div>
          </div>
          <i class="fa-solid fa-arrow-right tool-arrow"></i>
        </a>
  ...
  const validateAndSave = async () => {
    ...
    if (!email.match(/^[\w-]+@laplateforme\.io$/)) {
      ...
      if (!document.getElementById("emailError")) {
        ...
        errorDiv.innerHTML =
          '<i class="fa-solid fa-triangle-exclamation me-2"></i>Format invalide.';
